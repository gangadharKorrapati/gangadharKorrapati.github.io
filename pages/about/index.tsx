...
export const InpageContent = ({printPreview,printView}:{printPreview:boolean,printView:() => void}) => {
    return (
        ...
        <div className={printPreview ?  "invisible" :  "visible"}>
            <a href={userinfo.resume}  aria-label="download resume" download className="fixed grid w-10 h-10 rounded shadow-none justify-items-center bottom-32 right-8 bg-gradient-to-r from-green-400 to-blue-400 hover:from-red-400 hover:to-yellow-500 focus:outline-none focus:ring">
        ...
        <div onClick={()=>printView()}>
            <button className="fixed grid w-10 h-10 rounded shadow-none justify-items-center bottom-20 right-8 bg-gradient-to-r from-green-400 to-blue-400 hover:from-red-400 hover:to-yellow-500 focus:outline-none focus:ring" aria-label="toggle print view" >
            <div className="flex items-center justify-around w-full h-full align-middle">
